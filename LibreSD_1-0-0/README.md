...
LibreSD is a blazingly fast, minimal-footprint SD card driver and FAT filesystem library written in pure C. Designed to work on any MCU from 8-bit AVRs to 32-bit ARM Cortex.

## Features

- 🚀 **Fast as fuck** - Optimized for speed with DMA-friendly bulk transfers
